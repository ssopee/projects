...
<body>
    ...
    <div class="container">
        <div class="row" style="place-content: center;">
            <div class="col-lg-5 col-sm-4 col-8 backgroundcolor">
                ...
                <img src="assets/img/Register_ic.png" class="rounded mx-auto d-block imglogin">
                <?php if ($errorCode == 1) { ?>
                ...
                <div class="container">
                    <form role="form" action="controllers/RegisterController.php" method="POST">
                        <div class="login-1">
                            <div class="form-group">
                                <h6 class="fs-2">username : </h6>
                                <input type="text" class="form-control fs-1" name="username" id="username" placeholder="Enter username" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <h6 class="fs-2">confirm password : </h6>
                                <input type="password" class="form-control fs-1" name="confirm-pwd" id="confirm-pwd" placeholder="Enter password" required>
                            </div>
